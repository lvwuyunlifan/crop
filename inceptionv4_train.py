...
def main():
    ...
    # Mean is [0.47784190727519416, 0.5297897225227499, 0.389844720992831]
    # Var is [0.047577239458395565, 0.041848970144927444, 0.06305918836537383]

    # 图片归一化，由于采用ImageNet预训练网络，因此这里直接采用ImageNet网络的参数
    # normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
    normalize = transforms.Normalize(mean=[0.478, 0.5230, 0.390], std=[0.0476, 0.0418, 0.0631])
